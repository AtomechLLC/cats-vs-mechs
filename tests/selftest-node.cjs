...
check(
  '116. D-35 PART TWO, SURFACES TWO AND THREE: THE ROUND RULES ARE EDITED IN '
    ...
    + 'that check 117 was pressing one of them to author its rule. AND THE '
    + 'PRESS ON THE GREYED ADD IS CAUGHT BY THE PANEL RATHER THAN BY THE '
    + 'LIST - PROBE DH takes that guard out and the list still reads 8, '
    + 'because setRoundRule refuses slot 8 by name; what a student would '
    + 'actually get is the styled error panel raised by a control that '
    + 'looks switched off, so the panel being QUIET is the clause doing the '
    + 'work and the count is the one that cannot. THE PLACEMENT IS ASSERTED '
    + 'AND NOT ASSUMED: the fight\'s own block '
